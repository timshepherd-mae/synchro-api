...
print("*** Getting entities from Schedule=0...")
entities = get_all_entities(access_token, schedule['id'])
print("*** Entities obtained successfully.")
...
entities_out = save_response_records(
    records=entities,
    filename=output_file,
    filetype=FILETYPE_CSV
)

print_records(entities, n=15)